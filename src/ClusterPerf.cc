...
indexBasic()
{
    ...
    printf("# RAMCLOUD index write, overwrite, lookup+readHashes, and "
            ...
            "# and SkipList probability of %lf and %u levels. "
            "All keys are %d bytes and the value "
            ...
            SkipList::PROBABILITY, SkipList::MAX_FORWARD_POINTERS,
...
indexMultiple()
{
    ...
    printf("# RAMCloud write/overwrite performance for random object\n"
            ...
            "# indexing structure SkipList uses probability %lf and %u levels\n"
            ...
            SkipList::PROBABILITY, SkipList::MAX_FORWARD_POINTERS,
            numObjects, size, keyLength, keyLength,
