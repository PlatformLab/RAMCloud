...
#ifndef _STR_BTREE_MULTIMAP_H_
#define _STR_BTREE_MULTIMAP_H_
...
public:
    ...
    typedef str::btree<key_type, data_type, value_type, key_compare,
...
public:
    ...
    explicit inline btree_multimap(uint64_t tableId,
        ...
        : tree(tableId, objectManager, alloc)
    {
    }
    ...
    explicit inline btree_multimap(uint64_t tableId,
                                   ...
                                   const allocator_type &alloc =
                                            allocator_type())
        : tree(tableId, objectManager, kcf, alloc)
    {
    }

    /// Constructor initializing a B+ tree with the range [first,last)
    template <class InputIterator>
    inline btree_multimap(uint64_t tableId, ObjectManager *objectManager,
                          InputIterator first, InputIterator last,
                          const allocator_type &alloc = allocator_type())
        : tree(tableId, objectManager, first, last, alloc)
    {
    }
    ...
    inline btree_multimap(uint64_t tableId, ObjectManager *objectManager,
                          ...
                          const key_compare &kcf,
                          const allocator_type &alloc = allocator_type())
        : tree(tableId, objectManager, first, last, kcf, alloc)
    {
    }
