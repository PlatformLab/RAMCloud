 ...
 *
 * \param certificate
 *      A SegmentCertificate which is used to find the length of this
 *      segment and to check the integrity of its metadata.
 *      SegmentCertificates are generated by getAppendedLength().
 */
 ...
 * within the segment. This is primarily useful in building LogPosition
 * objects.
 */
uint32_t
