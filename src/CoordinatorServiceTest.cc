...
class CoordinatorServiceTest : public CppUnit::TestFixture {
    CPPUNIT_TEST_SUITE(CoordinatorServiceTest);
  ...
  public:
    ...
    void test_createTable() {
        ...
        CPPUNIT_ASSERT_EQUAL(0, get(service->tables, "foo"));
        CPPUNIT_ASSERT_EQUAL(1, get(service->tables, "bar"));
    ...
    void test_hintServerDown_backup() {
        ...
        CPPUNIT_ASSERT_EQUAL("", service->backupList.ShortDebugString());
    }
    ...
    void test_tabletsRecovered_basics() {
        ...
        CPPUNIT_ASSERT_EQUAL(1, service->tabletMap.tablet_size());
...
CPPUNIT_TEST_SUITE_REGISTRATION(CoordinatorServiceTest);
