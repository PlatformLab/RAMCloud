...
echo "# Note: numServers is actually how many servers serve benchmark data. Actual numer of serers is numServers +1"
echo "# where the +1 is for a control server"
