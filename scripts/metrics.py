...
class Struct(object):
    ...
    def dumpResetCode(self, out, name, fullName):
        # name is the path (e.g., 'metrics->master') to get to this struct
        #
        # fullName is the prefix of the path (e.g., 'metrics->master.') to get
        # to the members of this struct
...
def writeBuildFiles(definitions):
    ...
    cc('void Metrics::logMetrics()\n{')
    definitions.dumpLoggingCode(cc, 'metrics', '')
    cc('}')
    cc('\nvoid Metrics::resetMetrics()\n{')
    definitions.dumpResetCode(cc, 'metrics', '')
    cc('}')
    cc('} // namespace RAMCloud')
