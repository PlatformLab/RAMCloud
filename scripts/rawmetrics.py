...
rpc.metric('readKeysAndValueCount', 'number of invocations of READ_KEYS_AND_VALUE RPC')
...
rpc.metric('readKeysAndValueTicks', 'time spent executing READ_KEYS_AND_VALUE')
