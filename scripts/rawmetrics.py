...
rpc.metric('sendServerListCount', 'number of invocations of SEND_SERVER_LIST RPC')
...
rpc.metric('rpc48Count', 'number of invocations of RPC 48 (undefined)')
...
rpc.metric('sendServerListTicks', 'time spent executing SEND_SERVER_LIST RPC')
...
rpc.metric('rpc48Ticks', 'time spent executing RPC 48 (undefined)')
