...
def run_test(
    ...
    cluster_args = {
        ...
        'server_log_dir': options.server_log_dir,
...
def readDist(name, options, cluster_args, client_args):
    ...
    if (options.rcdf):
        print(  "\n\n"
                "# Inverse CDF statistics for clusterperf.py %s'\n#\n"
                "# Time (usec)  Cum. Fraction\n"
                "#---------------------------" % name)
        print_rcdf_from_log()
...
def readDistRandom(name, options, cluster_args, client_args):
    ...
    print("# Cumulative distribution of time for a single client to read a\n"
          ...
          "# that a given fraction of all reads took at most a given time\n"
          "# to complete.\n"
          "# Generated by 'clusterperf.py readDistRandom'\n#\n"
          "# Time (usec)  Cum. Fraction\n"
          "#---------------------------"
          % options.size)
...
if __name__ == '__main__':
    ...
    parser.add_option('--serverLogDir', default=None, metavar='SDIR',
            dest='server_log_dir',
            help='Top level directory for log server files; '
                 'overrides --logDir for severs only.')
